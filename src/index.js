...
app.use(cors({
  origin : (origin, callback) => {
    ...
    if (!origin)
      return callback(new Error("No origin specified"), false);
...
const SequelizeConnectSession =
    SequelizeConnectSessionConstructor(expressSession.Store)
...
// instead of JWTs.
// https://github.com/stuysu/api.stuyactivities.org/blob/1ff39ef0d229e6295bcb190e9cba279d72a812fb/src/middleware/session.js
